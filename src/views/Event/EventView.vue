    ...
    <div class="flex flex-col mb-3">
      ...
      <div class="relative mb-4">
        ...
        <div
          ...
          v-if="event?.beginsOn"
        >
          <skeleton-date-calendar-icon v-if="eventLoading" class="w-full" />
          <date-calendar-icon
            v-else
        ...
        <section class="intro" style="padding: 20px" dir="auto">
          <div class="flex flex-wrap justify-end" style="gap: 16px">
            <div class="flex-1 min-w-[300px]">
              ...
              <div
                class="flex flex-wrap items-center mt-2 my-3"
                style="gap: 8px"
              >
                <div
                  v-if="eventLoading"
      ...
      <div class="flex flex-col md:flex-row gap-4 w-full mt-1">
        <aside
            ...
            >
              <div style="padding: 20px">
                ...
                >
                  {{ t("Attendees") }}
                  <span
                    v-if="eventParticipants && eventParticipants.length > 0"
                    class="text-gray-500"
                    style="
                      font-weight: 500;
                      font-size: 15px;
                  ...
                  <span
                    v-else-if="
                      ...
                      (event.participantStats.going > 0 ||
                ...
                <div
                  v-else-if="eventParticipants && eventParticipants.length > 0"
                ...
                >
                  ...
                  <!-- Show All Button -->
                  <div
                    v-if="eventParticipants.length > 5"
                ...
                >
                  {{
                    t(
                      "Participant information will appear here once available."
                    )
                  }}
                </div>
